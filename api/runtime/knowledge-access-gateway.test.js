...
test("knowledge access gateway retrieves jurisdiction-scoped knowledge with provenance", async () => {
...
test("knowledge access gateway requires an authenticated actor and jurisdiction", async () => {
